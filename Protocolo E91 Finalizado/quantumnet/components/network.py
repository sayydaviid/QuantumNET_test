...
class Network():
    ...
    def __init__(self) -> None:
        ...
        self._application = ApplicationLayer(self, self._network, self._link, self._physical)
        # Sobre a execução
    ...
    def application_layer(self):
        """
        Camada de aplicação da rede.

        Returns:
            ApplicationLayer : Camada de aplicação da rede.
        """
